...
// ── Tra cứu NỘI BỘ (backoffice) theo từ khoá tự do `q` trên bảng `members`. ──
// Tra cứu hội viên CÔNG KHAI (SĐT + mật khẩu CCCD) đã chuyển sang
// /api/membership/lookup-sheet (đọc trực tiếp Google Sheet Hợp Đồng Bán).
...
const MEMBER_COLUMNS =
  'id, member_code, full_name, phone, email, id_number, status, registered_date, expiry_date, branch, service_package, consultant_name, address, notes, contract_value';
