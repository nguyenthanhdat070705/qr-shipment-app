          ...
          {menuItems.map((item) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className={`text-sm font-semibold ${item.active ? 'text-[#162240]' : 'text-gray-800'}`}>
                  {item.label}
                </p>
        ...
        <main className="lg:ml-72 min-h-screen transition-all duration-300">
          ...
          <div className="mx-auto max-w-lg px-5 pb-6 lg:hidden">
            <div className="grid grid-cols-2 gap-3">
              ...
              <Link
                href="/product/fullproductlist"
                className="flex flex-col items-center gap-2 p-4 rounded-2xl border border-gray-200 bg-white hover:border-[#a8b4ce] hover:shadow-md transition-all"
              >
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-[#eef1f7]">
                  <LayoutGrid size={20} className="text-[#2d4a7a]" />
                </div>
