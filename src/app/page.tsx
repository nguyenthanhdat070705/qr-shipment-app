...
import { QrCode, ScanLine, Package, CheckCircle, Settings2, ArrowRight } from 'lucide-react';
import { PRODUCT_CONFIG } from '@/config/product.config';
import QuickLookupForm from '@/components/QuickLookupForm';

export const metadata: Metadata = {
  title: 'Tìm sản phẩm — QR Xuất kho',
  description: 'Quét mã QR hoặc nhập mã sản phẩm để xem thông tin và xác nhận xuất kho.',
};
...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-50">
      {/* ── Hero ─────────────────────────────────────── */}
      <div className="mx-auto max-w-lg px-5 pt-12 pb-8 text-center">
