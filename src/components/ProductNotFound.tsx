...
export default function ProductNotFound({ lookupValue }: ProductNotFoundProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-[#faf7f2] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#1B2A4A] px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[#162240] active:scale-95 transition-all"
          >
            <ArrowLeft size={16} />
            Quay về trang chủ
          </Link>
