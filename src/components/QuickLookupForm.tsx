    ...
    <div className="space-y-3">
      ...
      {inputMode === 'type' ? (
        ...
        <form onSubmit={handleSubmit} className="flex gap-2">
          ...
          <button
            ...
            className="rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white
                       hover:bg-indigo-700 active:scale-95 transition-all inline-flex items-center gap-1.5"
          >
            <ArrowRight size={15} />
            Tìm
          </button>
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-xl overflow-hidden border-2 border-indigo-300 bg-black relative aspect-square max-h-[300px] mx-auto flex items-center justify-center">
            <Scanner
              onScan={(result) => {
