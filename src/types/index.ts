...
export interface ConfirmShipmentRequest {
  ...
  maDonHang?: string; // Mã đám (không bắt buộc)
  soLuong?: number; // Số lượng xuất (mặc định 1)
}
...
/** Trạng thái GRPO */
export type GRStatus = 'completed' | 'cancelled' | 'pending' | 'inspecting' | 'pending_po' | 'pending_confirm';
